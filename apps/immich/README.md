...
> **SUPERSEDED — do not deploy from this directory.** `immich` reconciles
> from its own repository at `immich/k8s/` (ADR 0001 app-repo model); no Argo
...
> 1.31.0**. The live `immich-pg` moved to the Barman Cloud plugin
