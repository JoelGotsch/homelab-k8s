...
> **SUPERSEDED — do not deploy from this directory.** `paperless` reconciles
> from its own repository at `paperless/k8s/` (ADR 0001 app-repo model); no Argo
...
> 1.31.0**. The live `paperless-pg` moved to the Barman Cloud plugin
