...
> **SUPERSEDED — do not deploy from this directory.** `llm-gateway` reconciles
> from its own repository at `llm-gateway/k8s/` (ADR 0001 app-repo model); no Argo
...
> 1.31.0**. The live `llm-gateway` moved to the Barman Cloud plugin
