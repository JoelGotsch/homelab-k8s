...
> **SUPERSEDED — do not deploy from this directory.** `nextcloud` reconciles
> from its own repository at `nextcloud/k8s/` (ADR 0001 app-repo model); no Argo
...
> 1.31.0**. The live `nextcloud-pg` moved to the Barman Cloud plugin
