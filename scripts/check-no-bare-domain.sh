...
KNOWN_VIOLATIONS_REGEX='^nextcloud:k8s/values\.yaml$|^paperless:k8s/values\.yaml$|^vaultwarden:k8s/values\.yaml$|^ntfy:k8s/configmap\.yaml$|^librechat:k8s/deployment\.yaml$|^llm-gateway:k8s/registry-reconcile-(configmap|cronjob)\.yaml$'
